...
object OnTimeColors {
    val ConsoleBody = Color(0xFF34465C)
    val ConsoleEdge = Color(0xFF71869F)
    val ConsoleShadow = Color(0xFF080F1D)
    val DeepBlue = Color(0xFF111D31)      // 主背景:非纯黑的深蓝
    val DeepBlueHigh = Color(0xFF1B2B43)  // 层次提升面
